...
length(intersection((E(gldgene)),(E(gzall))))
ecount(gldgene)
length(intersection((V(gldgene)),(V(gzall))))
vcount(gldgene)
length(difference((E(gldgene)),(E(gzall))))
length(difference((E(gzall)),(E(gldgene))))

length(E(gldgene))
difference(E(gzall),E(simplify(gzall)))
difference(E(gldgene),E(simplify(gldgene)))
gzall<-simplify(gzall)
gldgene<-simplify(gldgene)
...
gzall_2<-delete_vertices(gzall, names(gzallCoreness[gzallCoreness<10]))
...
gld_2<-delete_vertices(gldgene, names(gldcoreness[gldcoreness<8]))
...
jpeg(file="figures/corematrix.jpg")
...
V2=intersection(V(gzall),V(gldgene))
length(V2)
length(V(gldgene))
